...
import pombo.core.designsystem.generated.resources.eye_icon
import pombo.core.designsystem.generated.resources.eye_off_icon
import pombo.core.designsystem.generated.resources.hide_password
import pombo.core.designsystem.generated.resources.show_password

@Composable
fun PomboPasswordTextField(
...
fun PomboPasswordTextFieldEmptyPreview() {
    PomboTheme {
        PomboPasswordTextField(
            ...
            title = "Password",
            supportingText = "Use at least 9+ characters...",
        )
    }
}
...
fun PomboPasswordTextFieldFilledPreview() {
    PomboTheme {
        PomboPasswordTextField(
...
fun PomboPasswordTextFieldErrorPreview() {
    PomboTheme {
        PomboPasswordTextField(
            state = rememberTextFieldState(),
            isPasswordVisible = false,
